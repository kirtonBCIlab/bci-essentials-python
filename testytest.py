...
# Load the xdf
test_mi.load_offline_eeg_data(filename  = "..\\fatigueDataAnalysis\\fatigueData\\participants\\sub-P18_mi\\ses-postRS_mi\\eeg\\sub-P18_mi_ses-postRS_mi_task-T1_run-001_eeg.xdf", print_output=False) # you can also add a subset here
